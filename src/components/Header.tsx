        ...
        <div className="flex justify-between items-center h-28">
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden lg:block">
              ...
              <p className="text-lg text-gray-600 font-medium">Medicina Estética</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-gray-700 hover:text-blue-900 font-medium transition-colors text-lg"
            >
              Inicio
            </button>
            <button
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-900 to-blue-800 text-white px-8 py-3 rounded-full font-semibold hover:from-blue-800 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-lg"
            >
              Contacto
            </button>
          </nav>
          ...
          <div className="hidden xl:flex items-center space-x-8">
            ...
            <div className="flex items-center text-gray-600 hover:text-blue-900 transition-colors">
              ...
              <span className="font-medium">dra.carmensanchezmoreno@gmail.com</span>
            </div>
          </div>
