...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 pt-32 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-12 animate-fade-in-up">
            <div className="space-y-10">
              ...
              <p className="text-2xl md:text-3xl text-gray-600 leading-relaxed max-w-3xl font-light">
            ...
            <div className="grid grid-cols-3 gap-8">
              <div className="group text-center p-8 bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-blue-100 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-4 hover:scale-105">
                <Award className="h-14 w-14 text-blue-900 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                <div className="text-4xl font-bold text-blue-900 mb-2">35+</div>
                <div className="text-lg text-gray-600 font-semibold">Años de experiencia</div>
              </div>
              <div className="group text-center p-8 bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-blue-100 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-4 hover:scale-105">
                <Users className="h-14 w-14 text-blue-900 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                <div className="text-4xl font-bold text-blue-900 mb-2">2000+</div>
                <div className="text-lg text-gray-600 font-semibold">Pacientes satisfechos</div>
              </div>
              <div className="group text-center p-8 bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-blue-100 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-4 hover:scale-105">
                <Shield className="h-14 w-14 text-blue-900 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                <div className="text-4xl font-bold text-blue-900 mb-2">100%</div>
                <div className="text-lg text-gray-600 font-semibold">Seguridad garantizada</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-8">
              <button
                ...
                className="group bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 text-white px-12 py-6 rounded-3xl font-bold text-xl hover:from-blue-800 hover:via-blue-700 hover:to-blue-600 transition-all duration-500 shadow-2xl hover:shadow-3xl transform hover:-translate-y-3 hover:scale-105 relative overflow-hidden"
              >
              ...
              <button
                ...
                className="group border-4 border-blue-900 text-blue-900 px-12 py-6 rounded-3xl font-bold text-xl hover:bg-blue-900 hover:text-white transition-all duration-500 shadow-xl hover:shadow-3xl transform hover:-translate-y-3 hover:scale-105 relative overflow-hidden"
              >
            ...
            <div className="flex items-center space-x-8 pt-8">
              ...
              <div className="text-gray-600 font-semibold">Presidenta Sección Colegial</div>
            </div>
          </div>
          ...
          <div className="relative animate-fade-in-right">
            <div className="relative z-10">
              ...
              <img
                ...
                alt="Dra. Carmen Sánchez Moreno - Medicina Estética"
                className="relative rounded-3xl shadow-3xl w-full h-[700px] object-cover transform -rotate-6 hover:rotate-0 transition-transform duration-700 border-4 border-white"
              />
              <div className="absolute -bottom-8 -right-8 bg-gradient-to-r from-blue-900 to-blue-800 text-white p-8 rounded-3xl shadow-2xl border-4 border-white">
                <div className="text-center">
                  <div className="text-3xl font-bold mb-2">Presidenta</div>
                  <div className="text-lg">Sección Colegial de</div>
                  <div className="text-lg">Medicina Estética</div>
                </div>
              </div>
              <div className="absolute -top-8 -left-8 bg-white p-6 rounded-2xl shadow-2xl border border-blue-100">
                <div className="text-center">
